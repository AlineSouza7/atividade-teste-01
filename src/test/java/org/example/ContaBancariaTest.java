...
public class ContaBancariaTest {
    ...
    @BeforeEach
    public void setUp() {
        contaBancaria = new ContaBancaria("123", "Aline");
    }
    ...
    public void test_transferir() {
        test_depositar();
        ContaBancaria contaBancaria2 = new ContaBancaria("456", "Gabriel");
    ...
    public void test_alterar_titular() {
        assertTrue(contaBancaria.alterarTitular("aline"));
    ...
    public void test_get_titular() {
        assertEquals("Aline", contaBancaria.getTitular());
    }
